...
const memoize = <Obj extends object, Result>(
  ...
  const memoizedFn = (obj: Obj) => {
    ...
    setTimeout(() => {
      console.log('dxy after', 'memoList:', memoList);
      console.log('dxy after', 'resultCache:', memoList);
      console.log('dxy after', 'proxyCache:', memoList);
    }, 10* 1000);
    console.log('dxy before', 'memoList:', memoList);
    console.log('dxy before', 'resultCache:', memoList);
    console.log('dxy before', 'proxyCache:', memoList);
    return result;
  };
  return memoizedFn;
};
